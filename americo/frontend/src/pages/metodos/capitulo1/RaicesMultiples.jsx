...
const RaicesMultiples = () => {
  ...
  return (
    <div className="raices-multiples-container">
      <h2>Método de Raíces Múltiples</h2>
      <form onSubmit={handleSubmit} className="form-raices-multiples">
        <label>
          Función f(x):
          <input
            type="text"
      ...
      {tabla.length > 0 && (
        <table className="tabla-raices-multiples">
          <thead>
            <tr>
              <th>Iteración</th>
              <th>x</th>
          ...
          <tbody>
            {tabla.map((fila, index) => (
              <tr key={index}>
                ...
                <td>{fila.fx2.toExponential(2)}</td>
